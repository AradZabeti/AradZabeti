...
<img src="./assets/spotify.svg" width="900" alt="Spotify Now Playing — live" />

**Live playback · automatically refreshed every 15 minutes**
...
**My music stack:** Trumpet · Music Theory · Ear Training · Practice Systems · Audio Technology · AI × Music

> The Spotify card is generated by GitHub Actions from Spotify's Web API. No Spotify credentials are stored in the README.
...
- [x] KookTools
- [x] Professional profile README
- [x] Contribution Snake
- [x] Spotify Now Playing infrastructure
- [x] Music + technology direction
- [ ] Production-grade AI agent
- [ ] Full music practice platform
...
**[GitHub](https://github.com/AradZabeti)** · **[Portfolio](https://aradzabeti.github.io/AradZabeti/)** · **[KookTools](https://kooktools.netlify.app)** · **[Telegram](https://t.me/KindButSelective)**
